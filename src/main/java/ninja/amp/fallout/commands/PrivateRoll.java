...
public class PrivateRoll extends Command {
    ...
    public PrivateRoll(Fallout fallout) {
        super(fallout, "privateroll");
        setDescription("Privately rolls the dice with one of your character's traits.");
        setCommandUsage("/fo privateroll <trait>");
    ...
    public void execute(String command, CommandSender sender, String[] args) {
        ...
        if (trait == null) {
            ...
            if (characterManager.isOwner(playerId)) {
                ...
                fallout.getMessenger().sendMessage(player, FOMessage.ROLL_MESSAGE, roll, trait.getName());
            } else {
