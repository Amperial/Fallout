...
/**
 * Manages fallout message sending, logging, and debugging.
 */
public class Messenger {
    ...
    public Messenger(Fallout fallout) {
        ...
        messagePrefix = messages.containsKey("prefix") ? messages.get("prefix") : ChatColor.RED + "[" + ChatColor.YELLOW + "Fallout" + ChatColor.RED + "] " + ChatColor.YELLOW;
    }
    ...
    public void debug(Exception e) {
        if (debug) {
            ...
            log.severe("If this bug hasn't been reported please open a ticket at https://github.com/ampayne2/Fallout/issues");
